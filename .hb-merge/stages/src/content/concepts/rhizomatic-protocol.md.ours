...
the non-linear _potential_ of this pipeline was acknowledged, the very metaphor of a pipeline
...
messy, opportunistic, and non-linear nature of real inquiry**. It is not a transparent map of a
...
their type or the direction of the arrow. It is about understanding the artifact's _context_ within
...
3. **Spawning of New Nodes:** These observations, generated by the friction of the `Project`, were
   ...
   `Concept` document, such as _"The Ghost in the Byline."_
...
- **The Aesthetic of the Protocol** is now understood not as an aesthetic of linear elegance, but as
  ...
  with its complex and multi-directional links, _is_ the primary aesthetic object. It is a sculpture
...
1. **"A Thousand Plateaus: Capitalism and Schizophrenia."** Deleuze, G., & Guattari, F. (1980).
   _Epistemic Note: The foundational text for "rhizomatic" thought. Its model of a non-hierarchical,
   interconnected network with no beginning or end is the direct philosophical basis for the
   corrected model of the Effusion Labs protocol presented here._
2. **"The Structure of Scientific Revolutions."** Kuhn, T. S. (1962). _Epistemic Note: Kuhn's
   ...
   friction-driven evolution of the Effusion Labs project._
3. **"Serendipity: Accidental Discoveries in Science."** Roberts, R. M. (1989). _Epistemic Note:
   ...
   the pipeline model._
4. **[PROJECT] Curatorial Generativism.** Effusion Labs. (Internal Link). _Epistemic Note: The
   artistic framework that this document serves to correct and refine._
5. **[PROJECT] Takashi Murakami - Lithographs...** Effusion Labs. (Internal Link). _Epistemic Note:
   The key case study, re-contextualized here as a "Project-as-Spark."_
6. **[META-OBSOLETE] The Atlas of a Process.** Effusion Labs. (Internal Link). _Epistemic Note:
   Explicitly flagged as an obsolete document whose linear "pipeline" model is superseded by this
   text._
7. **Cybernetics.** Wiener, N. (1948). _Epistemic Note: The principles of feedback are central to
   ...
   pipeline._
8. **"The Open Work."** Eco, U. (1962). _Epistemic Note: Eco's theory of artworks that are
   ...
   own path through the network._
9. **"Bricolage."** A term used by anthropologist Claude Lévi-Strauss. _Epistemic Note: Describes
   ...
   sparks, and project friction to build new structures._
10. **The World Wide Web itself.** Berners-Lee, T. (c. 1990). _Epistemic Note: The original
    architecture of the web, based on the hyperlink, is fundamentally rhizomatic and
    non-hierarchical. The Effusion Labs "digital garden" mimics this structure._
11. **"A Pattern Language."** Alexander, C., et al. (1977). _Epistemic Note: While previously cited
    ...
    opportunistically to solve problems as they arise._
12. **"Lateral Thinking: A Textbook of Creativity."** de Bono, E. (1970). _Epistemic Note: De Bono's
    methods for breaking out of linear, vertical thinking patterns directly support the kind of
    non-obvious leaps (e.g., Project-as-Spark) that the rhizomatic model describes._
13. **"Error-correction."** A concept from information theory and computer science. _Epistemic Note:
    This entire article is a performance of an error-correction protocol, demonstrating a system
    capable of identifying and correcting flaws in its own descriptive models._
14. **The practice of "mind mapping."** _Epistemic Note: A visual thinking tool that uses a
    non-hierarchical, radial structure to connect ideas, providing a simple visual analogue for the
    rhizomatic network model._
15. **The history of the discovery of penicillin.** Fleming, A. (1928). _Epistemic Note: The classic
    ...
    inquiry._
16. **"Against Method."** Feyerabend, P. (1975). _Epistemic Note: Feyerabend's argument that there
    ...
    opportunistic network._
17. **The I Ching (Book of Changes).** An ancient Chinese divination text. _Epistemic Note:
    ...
    generates insight from constrained, non-linear interactions._
18. **The journal of a working scientist or artist.** A generic example. _Epistemic Note: The
    ...
    intuition—a real-world confirmation of the rhizomatic process._
19. **"The Art of Failure: An Essay on the Scapegoat."** Stiegler, B. (2015). _Epistemic Note:
    ...
    principle._
20. **"Path-dependency."** A concept from economics and social sciences. _Epistemic Note: The
    ...
    structure of the network._
21. **The 'exquisite corpse' surrealist game.** _Epistemic Note: A game where participants
    ...
    non-linear, and semi-random process._
