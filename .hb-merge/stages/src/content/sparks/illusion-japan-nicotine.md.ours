...
> _A regulatory system that treats its adult citizens as children will inevitably produce a market
...
> customers like adults—for better or worse._
...
The key shift was from _flavor addition_ to _flavor modulation_. Early capsules were a binary on/off
...
certain cynicism. A 2020 study in _Tobacco Control_ on brand marketing in Korea (a market with
...
switching from complex HTPs _back_ to conventional cigarettes, citing a desire for a more
...
> _Epistemic Note (Primary):_ Provides a comprehensive, real‑time snapshot of the HTP SKUs available
...
> _Epistemic Note (Primary):_ Documents the product lineage and churn for a specific capsule-based
...
[^3]: **[Japan Tobacco, 2020]** – _Method and apparatus for manufacturing flavor capsule of tobacco
    (US10694777B2)_

> _Epistemic Note (Primary):_ A patent for manufacturing multi‑layered flavor capsules, providing
...
[^4]: **[Philip Morris, 2006]** – _Capsule for articles for smoking and methods of producing same
    (EP1850685B1)_

> _Epistemic Note (Primary):_ Early patent focused on the chemical stability of capsule contents,
...
[^5]: **[Philip Morris, 2023]** – _Hydrophobic surface treatments on capsules for smoking articles
    (US11849756B2)_

> _Epistemic Note (Primary):_ Recent patent for hydrophobic surface treatments on capsules,
...
[^6]: **[Japan Tobacco, 2024]** – _Flavor stick, heat‑not‑burn‑type flavor inhalation product, and
    method for producing flavor stick (EP4420536A1)_

> _Epistemic Note (Primary):_ Patent detailing complex airflow management within a flavor‑generating
...
> _Epistemic Note (Primary):_ Competitor patent specifically for HTP‑optimized capsules, showing how
...
> _Epistemic Note (Primary):_ Direct consumer preference data from a poll of adult users, providing
...
> _Epistemic Note (Primary):_ Longitudinal survey data providing demographic and behavioral context
...
> _Epistemic Note (Adversarial):_ Critical perspective on the US regulatory approach, highlighting
...
[^11]: **[RELAZO-2025 / IQOS Pearl Discontinuation]** – _Relazo.net, Japanese product metadata
    aggregator_

> _Epistemic Note (Primary):_ Market report on the discontinuation of the IQOS Pearl capsule series,
...
> _Epistemic Note (Conceptual):_ Framework for understanding rapid product iteration as a deliberate
...
> _Epistemic Note (Primary):_ Corporate source material for analyzing the “product theater”
> argument.\
> Source: [JTI Corporate Site](https://www.jti.com/)

[^14]: **[WHO, 2025]** – _Information Sheet: Flavour accessories in tobacco products enhance
    attractiveness and appeal_

> _Epistemic Note (Adversarial):_ Public health report arguing that flavor accessories enhance
> attractiveness and may undermine cessation, offering a counterpoint to the “consumer empowerment”
> narrative.\
> Source:
> [WHO Infosheet](https://cdn.who.int/media/docs/default-source/tobacco-hq/infosheet-flavouraccessories.pdf)
