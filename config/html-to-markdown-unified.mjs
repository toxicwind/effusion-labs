...
export default function htmlToMarkdownUnified(eleventyConfig, {
    rootDir = "src/content",
    dumpMarkdownTo = null,
    defaultLayout = null,
    pageTitlePrefix = "",
    ...
    eleventyConfig.addExtension("html", {
        ...
        compile: function (inputContent, inputPath) {
            ...
            return async () => {
                ...
                if (dumpMarkdownTo) {
                    const relOut = inputPath.replace(path.normalize(rootDir) + path.sep, "");
                    const mdOutPath = path.join(dumpMarkdownTo, relOut.replace(/\.html$/i, ".md"));
