...
function buildMarkdown(report) {
  ...
  lines.push("");
  lines.push("This file is generated by `tools/generate-remote-assets-report.mjs`. Re-run the script after a fresh `npm run build` to update the inventory.");
  lines.push("");
...
async function main() {
  ...
  console.log(`Wrote remote asset audit (${report.uniqueCount} URLs) to ${path.relative(projectRoot, outputPath)}`);
}
