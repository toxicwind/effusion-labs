...
const HTMLLinkParser = (
  await import(pathToFileURL(path.join(MOD, 'html-link-parser.js')).href)
).default
const WikilinkParser = (
  await import(pathToFileURL(path.join(MOD, 'wikilink-parser.js')).href)
).default
