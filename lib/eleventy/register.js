...
const { specnote, callout, failbox } = require('../shortcodes');
...
module.exports = function register(eleventyConfig) {
  ...
  eleventyConfig.addPassthroughCopy({ 'src/scripts/footnote-nav.js': 'assets/js/footnote-nav.js' });
  ...
  eleventyConfig.addPairedShortcode('failbox', failbox);
